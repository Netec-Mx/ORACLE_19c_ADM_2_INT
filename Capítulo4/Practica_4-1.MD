...
GRANT CREATE SESSION, CREATE TABLE, CREATE VIEW, CREATE PROCEDURE TO hr_app_user CONTAINER = ALL;
GRANT SELECT ANY DICTIONARY TO hr_app_user CONTAINER = ALL;
```
...
CONNECT hr_app_user/Oracle123_HR@localhost/app_root
