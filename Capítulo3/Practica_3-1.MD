...
#### **Paso 1.** Verificar y establecer variables de entorno en la cuenta oracle:
...
```sql
-- Verifica el destino y tamaño del FRA, actualiza los parámetros a los valores indicados.

sqlplus / as sysdba
show parameter db_recovery_file_dest;

-- Si es necesario, haz que los parámetros coincidan con los siguientes valores.
...
#### **Paso 2.** Crear directorio con permisos adecuados (solo si no existe):

```bash
# Verificar si existe el directorio de FRA
ls -ld /u01/app/oracle/fast_recovery_area

# Si el directorio no existe crearlo con los siguientes comandos:
