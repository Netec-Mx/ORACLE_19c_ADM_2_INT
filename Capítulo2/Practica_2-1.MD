...
```sql
-- CDB y PDBs
# En la cuenta sys del contenedor dar los siguientes comandos
sqlplus / as sysdba
...
-- Si alguna PDB no está en READ WRITE ejecutar la sentencia:
...
# Listar solo los nombres publicados de los servicios
